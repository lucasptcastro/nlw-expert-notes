  ...
  return (
    <button className="rounded-md text-left bg-slate-800 p-5 space-y-3 overflow-hidden outline-none relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
      ...
      <p className="text-sm leading-6 text-slate-400 ">
        ...
        molestiae incidunt a fuga perspiciatis accusantium. Aspernatur quo
        blanditiis facilis quam, eveniet autem fugit, totam quos deserunt modi,
        dolorum dolor? Aspernatur quo blanditiis facilis quam, eveniet autem
        fugit, totam quos deserunt modi, dolorum dolor? Aspernatur quo
        blanditiis facilis quam, eveniet autem fugit, totam quos deserunt modi,
        dolorum dolor?
      </p>
